  ...
  for (size_t i = 0; i < subpass_count_; i++) {
    ...
    // Wire up the dependencies from the subpass before and after this subpass.
    {
...

      {
        ...
        // In plain speak; all commands before this barrier must proceed till at
        // least the color-attachment writes in the color-attachment output
        // stage are executed. And, all commands after this barrier may continue
        // till they encounter an input attachment read in the fragment shader.
      ...
      // TODO(csg): Is this an insufficient dependency for the transition to the
      // external subpass?
    }
  }
