...
vars = {
  ...
  'skia_revision': '644e199b68329c93f98220a24b2dfa06285a0ef2',
  ...
  'dart_revision': 'ea1fce8e0aa7bb99251ffc4d247cef40ce82cfbf',
...
deps = {
  ...
  'src/third_party/dart/third_party/pkg/markdown':
   Var('dart_git') + '/markdown.git@82b050d0085a62b3b267097f5461c514e06ed139',

  'src/third_party/dart/third_party/pkg/matcher':
   Var('dart_git') + '/matcher.git@7228c26b9c8592e7c410ebff26f8bb136bad9ff7',

  'src/third_party/dart/third_party/pkg/mime':
   Var('dart_git') + '/mime.git@2d8496df6a6e851816610c3f99eae0d9663f54c4',

  'src/third_party/dart/third_party/pkg/mockito':
   Var('dart_git') + '/mockito.git@beb45ba75daeaa42a84c4db33576b7573e9cd51a',
  ...
  'src/third_party/dart/third_party/pkg/test':
   Var('dart_git') + '/test.git@b252463a588759ef0cdeb2dfeb19a9a76ae99296',
  ...
  'src/third_party/dart/third_party/pkg/tools':
   Var('dart_git') + '/tools.git@516995e62f046dc5a7f9fb487c8cd68be1692631',
  ...
  'src/flutter/impeller/doom':
  Var('github_git') + '/chinmaygarde/doompeller.git' + '@' + 'main',
     ...
     'packages': [
       {
        ...
        'version': 'moQlKaNgpc0WD3sjCsX7ZR9rKEo-OSRbNKOM2uCVCusC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': 'g_6rn9e-GBQGQGwgtbqJF1zS15H4U7WCXlQMFL03AEEC'
       }
     ],
